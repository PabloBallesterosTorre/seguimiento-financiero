  ...
  return (
    <form action={action}>
      ...
      <select
        ...
        className="w-full min-w-[8.5rem] rounded-btn border border-transparent bg-transparent px-1 py-1 text-[13px] text-ink-secondary hover:border-border-strong focus:border-border-strong"
      >
